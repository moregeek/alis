...
function partition() {
    ...
    if [ "$FILE_SYSTEM_TYPE" == "btrfs" ]; then
        ...
        umount /mnt
        mount -o "subvol=@,$PARTITION_OPTIONS,compress=lzo" "$DEVICE_ROOT" /mnt
        ...
        mount -o "subvol=@home_snapshots,$PARTITION_OPTIONS,compress=lzo" "$DEVICE_ROOT" /mnt/home/.snapshots
    else
        mount -o "$PARTITION_OPTIONS" "$DEVICE_ROOT" /mnt
